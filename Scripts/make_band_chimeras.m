...
if isempty(ChimeraFolder), ChimeraFolder = '/Users/fernandoaguilera/Desktop/Purdue/Courses/BME 511/Midterm Project'; end

% read original waveforms
cd(['/Users/fernandoaguileradealba/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Purdue/Courses/BME 511/'...
    'Midterm Project/Chimera WAV files']);
...
for nb = Nbands,
    ...
    cd(['/Users/fernandoaguileradealba/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Purdue/Courses/BME 511/' ...
        'Midterm Project/Chimeras']);
    audiowrite(chimfileA, env1_fts2, Fs);
    audiowrite(chimfileB, env2_fts1, Fs);
    cd(['/Users/fernandoaguileradealba/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Purdue/Courses/BME 511/' ...
        'Midterm Project/Scripts']);   
